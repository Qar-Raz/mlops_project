...
| ⬜ | **Evidently Dashboard:** Data drift on held-out test set | `localhost:7000` | |
| ⬜ | **Prometheus + Grafana:** Collect 3+ metrics (e.g., gpu_util) | `docker-compose` / Config | |
| ⬜ | **Proof:** Screenshot or public link included | `README.md` | |
